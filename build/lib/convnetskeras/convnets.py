...
def AlexNet(weights_path=None, heatmap=False):
    ...
    if heatmap:
        dense_1 = Convolution2D(4096, 2, 2, activation='relu', name='dense_1')(dense_1)
        dense_2 = Convolution2D(4096, 1, 1, activation='relu', name='dense_2')(dense_1)
        dense_3 = Convolution2D(3, 1, 1, name='dense_3')(dense_2)
...
def AlexNet_227(weights_path=None, heatmap=False):
    if heatmap:
        inputs = Input(shape=(3, None, None))
    else:
    ...
    if heatmap:
        dense_3 = Convolution2D(2, 1, 1, activation='relu', name='dense_3')(lastlayer)
        dense_4 = Convolution2D(2, 1, 1, name='dense_4')(dense_3)
